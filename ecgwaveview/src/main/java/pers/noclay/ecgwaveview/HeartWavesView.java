...
public class HeartWavesView extends View {
    ...
    private void resolveAttrs(AttributeSet attrs) {
        ...
        mXYTextColor = typeArray.getColor(R.styleable.HeartWavesView_xyTextColor, Color.BLACK);
        mWavesLineColor = typeArray.getColor(R.styleable.HeartWavesView_wavesLineColor, Color.BLACK);
        mXYTextSize = typeArray.getInteger(R.styleable.HeartWavesView_xyTextSize, 20);
        minY = typeArray.getInteger(R.styleable.HeartWavesView_minY, 0);
        maxY = typeArray.getInteger(R.styleable.HeartWavesView_maxY, 4100);
        refreshHz = typeArray.getInteger(R.styleable.HeartWavesView_refreshHZ, 20);
        dataHz = typeArray.getInteger(R.styleable.HeartWavesView_dataHZ, 333);
        xGridNum = typeArray.getInteger(R.styleable.HeartWavesView_xGridNum, 25);
        mTimeCount = typeArray.getFloat(R.styleable.HeartWavesView_mTimeCount, 2f);
        typeArray.recycle();
    }
